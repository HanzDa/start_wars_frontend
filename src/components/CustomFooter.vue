    ...
    <footer class="bg-neutral-300 text-center text-white dark:bg-neutral-600">
        <div class="container pt-9">
            <div class="mb-9 flex justify-center">
                <!-- Instagram -->
                <a href="https://www.instagram.com/hanzgallego07/" class="mr-9 text-neutral-800 dark:text-neutral-200">
                ...
                <!-- Linked In -->
                <a href="https://www.linkedin.com/in/hanzgallego/" class="mr-9 text-neutral-800 dark:text-neutral-200">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                        <path
                ...
                <!-- Github -->
                <a href="https://github.com/HanzDa" class="text-neutral-800 dark:text-neutral-200">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                        <path
